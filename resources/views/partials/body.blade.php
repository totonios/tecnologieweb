         ...
         <div class="slider_container">
               ...
               <img src="images/slider4.jpg" class="img-responsive" alt=""/>
                ...
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h1 class="title">Collezione 2017/2018<br>BY SKI360</h1>
                        <!-- /Text title -->
                        <div class="button"><a href="#">Preparati alla Rivoluzione</a></div>
                    </div>
                </div>
               <!-- /Texts container -->
            </div>
            ...
            <div class="slide">
               <img src="images/slider2.jpg" class="img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">Design Avanzato<br>Risultati EPICI</h1>
                       	<div class="button"><a href="/team.html">Conosci il TEAM</a></div>
                    </div>
                </div>
            </div>
            <!--/slide -->
